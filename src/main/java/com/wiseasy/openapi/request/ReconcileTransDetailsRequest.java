...
import com.wiseasy.openapi.response.ReconcileTransDetailsResponse;
...
@Setter
@ToString
public class ReconcileTransDetailsRequest extends OpenApiRequest<ReconcileTransDetailsResponse> {
